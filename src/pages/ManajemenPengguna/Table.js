...
function Table({ columns, data }) {
  ...
  const {
    ...
    if (totalSelectedUser === 0){
        confTotalSelectedUser = '*No users selected';
    } else if (totalSelectedUser === 1) {
        confTotalSelectedUser = '*1 user selected';
    } 
    else{
        confTotalSelectedUser = '*'+totalSelectedUser +' users selected';
    }
                    ...
                    <div class="">
                        ...
                        >
                            <div role="none">
                                ...
                                <div
                                    // onClick={() => [setShowModalUsersActive(false), setShowModalUsersInactive(true), setShowModalUsersDelete(false)]}
                                    key="setInactive"
