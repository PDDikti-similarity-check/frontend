...
export function TabelDetailCekData({ columns, data }) {
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
                                          ...
                                          <th>
                                            ...
                                            {headerGroup.headers.map(
                                                (column) => (
                                                    <th
                                                        scope="col"
                                                        className={`${column.render("Header") == "Presentase Similaritas"? 'px-4 py-[9px] text-left text-neutral-10 text-m font-[600] w-[140px]': 
                                                        column.render("Header") == "Alamat"? 'px-4 py-[9px] text-left text-neutral-10 text-m font-[600] w-[280px]':
                                                        column.render("Header") == "NIM/NPM"? 'px-4 py-[9px] text-left text-neutral-10 text-m font-[600] w-[130px]':
                                                        column.render("Header") == "Nama Lembaga"? 'px-4 py-[9px] text-left text-neutral-10 text-m font-[600] w-[200px]':
                                                        'px-4 py-[9px] text-left text-neutral-10 text-m font-[600] tracking-wider'}`}
...
export default TabelDetailCekData;
