    ...
    <div>
        ...
        <div className='mr-[200px] ml-[200px] mt-[40px] flex justify-center'>
          <div class="flex flex-col items-center justify-center">
            <input className='w-[500px] bg-[#FAFAFA] rounded-[15px] font-raleway text-[12px] border border-gray-300 appearance-none mb-3 py-3.5 px-3 leading-tight focus:outline-none focus:shadow-outline'  type='text'></input>
